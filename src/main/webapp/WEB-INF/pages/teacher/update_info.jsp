			...
			<div class="modal-body">
				<form class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="name_update" name="teacherName">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<p class="form-control-static" id="department_update"></p>
						</div>
					</div>
					<div class="form-group">
						<label for="department_update" class="col-sm-2 control-label">学位</label>
						<div class="col-sm-4">
					...
					<div class="form-group">
						<label for="department_update" class="col-sm-2 control-label">职称</label>
						<div class="col-sm-4">
