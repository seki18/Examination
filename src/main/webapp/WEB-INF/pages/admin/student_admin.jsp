...
<body>
	...
	<jsp:include page="../student/update_info.jsp"></jsp:include>
	<div class="container">
		<div class="row">
			<div class="col-md-2">
				<ul class="nav nav-pills nav-stacked" id="nav">
					<li><a href="../admin/course_admin">课程管理</a></li>
					<li class="active"><a href="../admin/student_admin">学生管理</a></li>
			...
			<div class="col-md-10">
				<div class="panel panel-default">
					...
					<div class="panel-heading">
						<div class="row">
							<h2 style="font-family: 黑体" class="col-md-2">学生管理</h2>
						</div>
					</div>
...
<script src="${PATH }/static/js/admin/student_admin.js"></script>
</html>