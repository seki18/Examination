		...
		<div class="row">
			<div class="col-md-2">
				<ul class="nav nav-pills nav-stacked" id="nav">
					...
					<li class="active"><a href="../student/choose_course">已选课程</a></li>
			...
			<div class="col-md-10">
				<div class="panel panel-default">
					...
					<div class="panel-heading">
						<div class="row">
							<h2 style="font-family: 黑体" class="col-md-2">已选课程</h2>
						</div>
					</div>
...
<script src="${PATH }/static/js/student/choose_course.js"></script>
